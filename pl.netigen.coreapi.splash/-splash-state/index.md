---
title: SplashState - api_android
---

[api_android](../../index.html) / [pl.netigen.coreapi.splash](../index.html) / [SplashState](./index.html)
...
| [LOADING](-l-o-a-d-i-n-g.html) |  |
| [SHOW_GDPR_CONSENT](-s-h-o-w_-g-d-p-r_-c-o-n-s-e-n-t.html) |  |
| [FINISHED](-f-i-n-i-s-h-e-d.html) |  |

...
[core-api](../../index.md) / [pl.netigen.coreapi.payments.model](../index.md) / [PaymentErrorType](./index.md)
...
| [SERVICE_TIMEOUT](-s-e-r-v-i-c-e_-t-i-m-e-o-u-t.md)) |  |
| [FEATURE_NOT_SUPPORTED](-f-e-a-t-u-r-e_-n-o-t_-s-u-p-p-o-r-t-e-d.md)) |  |
| [SERVICE_DISCONNECTED](-s-e-r-v-i-c-e_-d-i-s-c-o-n-n-e-c-t-e-d.md)) |  |
| [USER_CANCELED](-u-s-e-r_-c-a-n-c-e-l-e-d.md)) |  |
| [SERVICE_UNAVAILABLE](-s-e-r-v-i-c-e_-u-n-a-v-a-i-l-a-b-l-e.md)) |  |
| [BILLING_UNAVAILABLE](-b-i-l-l-i-n-g_-u-n-a-v-a-i-l-a-b-l-e.md)) |  |
| [ITEM_UNAVAILABLE](-i-t-e-m_-u-n-a-v-a-i-l-a-b-l-e.md)) |  |
| [DEVELOPER_ERROR](-d-e-v-e-l-o-p-e-r_-e-r-r-o-r.md)) |  |
| [ERROR](-e-r-r-o-r.md)) |  |
| [ITEM_ALREADY_OWNED](-i-t-e-m_-a-l-r-e-a-d-y_-o-w-n-e-d.md)) |  |
| [ITEM_NOT_OWNED](-i-t-e-m_-n-o-t_-o-w-n-e-d.md)) |  |

...
| [PaymentEvent](-payment-event.md)) | Represents Payment state it can be [PaymentSuccess](-payment-success/index.md), [PaymentRestored](-payment-restored/index.md) or [Error](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-error/index.md)`sealed class PaymentEvent` |

...
[core-api](../../index.md) / [pl.netigen.coreapi.ads](../index.md) / [IInterstitialAd](index.md) / [showIfCanBeShowed](./show-if-can-be-showed.md))
...
Shows ad if it is loaded and minimum time between this ads passed (limit can be ignored by [forceShow](show-if-can-be-showed.md)#pl.netigen.coreapi.ads.IInterstitialAd$showIfCanBeShowed(kotlin.Boolean, kotlin.Function1((kotlin.Boolean, kotlin.Unit)))/forceShow) = true)

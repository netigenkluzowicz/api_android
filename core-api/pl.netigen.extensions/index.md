...
[api_android](../index.md)(../index.md)/[core-api](../index.md) / [pl.netigen.extensions](./index.md)
...
| [toJson](to-json.html) | `fun <T> T.toJson(): `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.md) |

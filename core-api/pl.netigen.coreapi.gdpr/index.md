...
| [ICoreSplashFragment](-i-core-splash-fragment.md)) | Used for Gdpr pop-up fragment, see [IGDPRConsent](-i-g-d-p-r-consent/index.md)`interface ICoreSplashFragment : `[`GDPRClickListener`](-g-d-p-r-click-listener/index.md) |

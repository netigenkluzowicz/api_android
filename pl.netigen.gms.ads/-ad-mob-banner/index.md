...
| [getHeightInPixels](get-height-in-pixels.html) | Measures current banner implementation exact height in pixels`fun getHeightInPixels(): `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |

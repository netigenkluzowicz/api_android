...
[core](../../index.md) / [pl.netigen.core.language.info](../index.md) / [TranslationInfoDialogFragment](./index.md)

# TranslationInfoDialogFragment

`open class TranslationInfoDialogFragment : `[`BaseDialogFragment`](../../pl.netigen.core.utils/-base-dialog-fragment/index.md)

### Types

| [Builder](-builder/index.md) | `open class Builder` |
| [DialogClickListener](-dialog-click-listener/index.md) | `interface DialogClickListener` |

...
[core](../../index.html) / [pl.netigen.core.network](../index.html) / [NetworkStatus](./index.html)
...
| [addNetworkStatusChangeListener](add-network-status-change-listener.html) | `fun addNetworkStatusChangeListener(networkStatusChangeListener: NetworkStatusChangeListener): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
| [removeNetworkStatusChangeListener](remove-network-status-change-listener.html) | `fun removeNetworkStatusChangeListener(networkStatusChangeListener: NetworkStatusChangeListener): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
